...
def preprocess(file):
    ...
    return np.array(data,dtype=np.int64), headers

    
## Read the data
train_data, headers = preprocess("assignment3/train.csv")
valid_data, headers = preprocess("assignment3/valid.csv")
test_data, headers = preprocess("assignment3/test.csv")
#print(headers)
headers.insert(0,'Rich')
headers = headers[:-1]
